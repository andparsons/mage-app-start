...
MAGENTO_BASE_URL="http://mageee.localhost"
MAGENTO_BASE_URL_SECURE="https://mageee.localhost"
...
then
    ...
    bash -c "/usr/local/opt/php@7.2/bin/php -dmemory_limit=-1 bin/magento setup:upgrade"
    bash -c "/usr/local/opt/php@7.2/bin/php -dmemory_limit=-1 bin/magento setup:di:compile"
    bash -c "/usr/local/opt/php@7.2/bin/php -dmemory_limit=-1 bin/magento setup:static-content:deploy -f en_GB --jobs=2"
