...
then
    ...
    configSetLock "catalog/review/active" "1"
    configSetLock "catalog/review/allow_guest" "1"
    configSetLock "sendfriend/email/enabled" "1"
    configSetLock "sendfriend/email/allow_guest" "1"
    configSetLock "newsletter/general/active" "1"
    configSetLock "newsletter/subscription/allow_guest_subscribe" "1"
    configSetLock "newsletter/subscription/confirm" "0"
    configSetLock "wishlist/general/active" "1"
    configSetLock "wishlist/general/show_in_sidebar" "1"
