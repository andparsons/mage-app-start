...
/**
 * Interface is intended to be used in webapi only.
 * For other cases CartRepositoryInterface should be used.
 */
interface NegotiableCartRepositoryInterface extends CartRepositoryInterface
{
    /**
