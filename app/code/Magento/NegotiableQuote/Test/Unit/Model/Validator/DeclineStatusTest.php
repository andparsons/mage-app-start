...
/**
 * Unit test for DeclineStatus.
 */
class DeclineStatusTest extends AbstractStatusTest
{
    /**
     * @var string
     */
    protected $statusClass = \Magento\NegotiableQuote\Model\Validator\DeclineStatus::class;
    ...
    public function testValidate()
    {
        ...
        $this->restriction->expects($this->atLeastOnce())->method('canDecline')->willReturn(false);
    ...
    public function testValidateWithEmptyQuoteData()
    {
        ...
        $this->restriction->expects($this->never())->method('canDecline');
