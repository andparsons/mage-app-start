...
class MassDeleteTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->massDeleteController = $this->objectManager->getObject(
            \Magento\Support\Controller\Adminhtml\Backup\MassDelete::class,
            [
    ...
    public function testSelectedDelete()
    {
        ...
        $this->objectManagerMock->expects($this->atLeastOnce())->method('get')->willReturnMap(
            [
                [\Magento\Support\Model\ResourceModel\Backup\Collection::class, $this->backupCollectionMock],
                [\Magento\Support\Model\Backup::class, $this->modelMock]
            ]
        );
