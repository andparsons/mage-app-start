<?php
namespace Magento\Cybersource\Block\Adminhtml\System\Config\Field;
...
/**
 * Input field transformed to text node with link to store Cybersource webhooks controller.
 *
...
class WebhookUrl extends Field
{
    ...
    protected function _getElementHtml(AbstractElement $element)
    {
        ...
        if (!empty($originalData['handler_url'])) {
            $url = !empty($originalData['is_admin']) ? 'http(s)://{YourAdminPanelDomain}/' : $this->getStoreUrl();
