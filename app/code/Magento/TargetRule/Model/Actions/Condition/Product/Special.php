...
class Special extends \Magento\Rule\Model\Condition\Product\AbstractProduct
{
    ...
    public function __construct(
        ...
        $this->setType(\Magento\TargetRule\Model\Actions\Condition\Product\Special::class);
        $this->setValue(null);
    }
    ...
    public function getNewChildSelectOptions()
    {
        $conditions = [
            [
                'value' => \Magento\TargetRule\Model\Actions\Condition\Product\Special\Price::class,
